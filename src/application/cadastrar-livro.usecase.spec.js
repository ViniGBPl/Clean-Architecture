// Teste desenvolvido usando a logia do DTT
// Basicamente  a ideia é fazer o teste de forma simples que passe e depois desenvolver o user case.
// No caso, o useCase acaba por sofrer refactores para pode se manter e também o próprio teste.
...
describe('Cadastrar Livro UseCase', function(){
    ...
    test('Deve retornar um throw AppError se o livrosRepository não fornecido', function(){
    ...
    test('Deve retornar um Either.Left.valorJaCadastrado se já existir um ISBN cadastrado para um livro',async function(){
        ...
        expect(output.left).toEqual(Either.ISBNJaCadastrado('ISBN'));
